...
import com.fariz.travel.model.HistoryModel;
import com.fariz.travel.adapter.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    String id_book = "", asal, tujuan, tanggal, dewasa, anak, riwayat, total, hotel, city,type;
    String email;
    TextView tvNotFound;
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            @SuppressLint("Range") String total = cursor.getString(cursor.getColumnIndex("harga_total"));
            Log.d("hotel",total);
            if(asal.equals("hotel")){
                riwayat = "Berhasil melakukan booking untuk penginapan pada tanggal "+ tanggal +" di hotel"+tujuan +" di kota "+ dewasa +" selama "+ anak +" hari";
            } else {
