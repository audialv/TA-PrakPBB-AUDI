...
public class BookKeretaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] asal = {"Jakarta", "Semarang", "Purwokerto", "Yogyakarta", "Surabaya"};
        final String[] tujuan = {"Jakarta", "Semarang", "Purwokerto", "Yogyakarta", "Surabaya"};
                        ...
                        AlertDialog dialog = new AlertDialog.Builder(BookKeretaActivity.this)
                                ...
                                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        try {
                                            db.execSQL("INSERT INTO TB_BOOK (asalxx, tujuan, tanggal, dewasa, anak) VALUES ('" +
                                                    sAsal + "','" +
                                                    sTujuan + "','" +
                                                    sTanggal + "','" +
                                                    sDewasa + "','" +
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("semarang")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
